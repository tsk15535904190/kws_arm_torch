...
#ifndef AI_KWS_NETWORK_H
#define AI_KWS_NETWORK_H
#pragma once
...
/******************************************************************************/
#define AI_KWS_NETWORK_MODEL_NAME          "kws_network"
#define AI_KWS_NETWORK_ORIGIN_MODEL_NAME   "best_model"

/******************************************************************************/
#define AI_KWS_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_KWS_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_KWS_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_KWS_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_KWS_NETWORK_IN \
  ai_kws_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_NETWORK_IN_SIZE { \
  AI_KWS_NETWORK_IN_1_SIZE, \
}
#define AI_KWS_NETWORK_IN_SIZE_BYTES { \
  AI_KWS_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_KWS_NETWORK_IN_1_HEIGHT      (49)
#define AI_KWS_NETWORK_IN_1_CHANNEL     (1)
#define AI_KWS_NETWORK_IN_1_WIDTH       (10)
#define AI_KWS_NETWORK_IN_1_SIZE        (49 * 1 * 10)
#define AI_KWS_NETWORK_IN_1_SIZE_BYTES  (1960)

/******************************************************************************/
#define AI_KWS_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_KWS_NETWORK_OUT \
  ai_kws_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_NETWORK_OUT_SIZE { \
  AI_KWS_NETWORK_OUT_1_SIZE, \
}
#define AI_KWS_NETWORK_OUT_SIZE_BYTES { \
  AI_KWS_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_KWS_NETWORK_OUT_1_CHANNEL     (6)
#define AI_KWS_NETWORK_OUT_1_SIZE        (6)
#define AI_KWS_NETWORK_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_KWS_NETWORK_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup kws_network
 ...
 * @ref ai_kws_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_kws_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_kws_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_kws_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_KWS_NETWORK_*
 * defines into file @ref kws_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_kws_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_KWS_NETWORK_H */
