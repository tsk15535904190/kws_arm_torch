...
MFCC::MFCC(int num_mfcc_features, int frame_len)
    : num_mfcc_features(num_mfcc_features),
      frame_len(frame_len)
{
    // printf("num_mfcc_features:%d\r\n",num_mfcc_features);
    // printf("frame_len:%d\r\n",frame_len);
    // printf("MFCC::num_mfcc_features:%d\r\n",MFCC::num_mfcc_features);
    // printf("MFCC::frame_len:%d\r\n",MFCC::frame_len);
...
float **MFCC::create_mel_fbank()
{
    ...
    float **s_mel_fbank = new float *[NUM_FBANK_BINS];
    ...
    for (bin = 0; bin < NUM_FBANK_BINS; bin++)
    {
        ...
        s_mel_fbank[bin] = new float[last_index - first_index + 1];
